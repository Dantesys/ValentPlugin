...
public class DomadorEvent implements Listener {
    ...
    public void sumonalobo(Player player,Entity entity) {
        ...
        meta.addAttributeModifier(Attribute.ATTACK_DAMAGE,new AttributeModifier(Attribute.ATTACK_DAMAGE.getKey(),9, AttributeModifier.Operation.ADD_NUMBER));
        armadura.setItemMeta(meta);
        Wolf wolf = (Wolf) player.getWorld().spawnEntity(entity.getLocation(), EntityType.WOLF);
        wolf.setOwner(player);
        wolf.registerAttribute(Attribute.MAX_HEALTH);
        Objects.requireNonNull(wolf.getAttribute(Attribute.MAX_HEALTH)).setBaseValue(200);
        wolf.attack(entity);
        wolf.setTamed(true);
        ...
        wolf2.registerAttribute(Attribute.MAX_HEALTH);
        Objects.requireNonNull(wolf2.getAttribute(Attribute.MAX_HEALTH)).setBaseValue(100);
        wolf2.attack(entity);
        wolf2.setTamed(true);
        ...
        wolf3.registerAttribute(Attribute.MAX_HEALTH);
        Objects.requireNonNull(wolf3.getAttribute(Attribute.MAX_HEALTH)).setBaseValue(100);
        wolf3.attack(entity);
        wolf3.setTamed(true);
        ...
        wolf4.registerAttribute(Attribute.MAX_HEALTH);
        Objects.requireNonNull(wolf4.getAttribute(Attribute.MAX_HEALTH)).setBaseValue(100);
        wolf4.attack(entity);
        wolf4.setTamed(true);
        ...
        wolf5.registerAttribute(Attribute.MAX_HEALTH);
        Objects.requireNonNull(wolf5.getAttribute(Attribute.MAX_HEALTH)).setBaseValue(100);
        wolf5.attack(entity);
        wolf5.setTamed(true);
