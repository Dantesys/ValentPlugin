...
public enum MobList {
    ...
    CAMEL(EntityType.CAMEL,"Creaking",Material.CAMEL_SPAWN_EGG),
    CREAKING(EntityType.CREAKING,"Creaking",Material.CREAKING_SPAWN_EGG);
    private final EntityType entityType;
    private String friendlyName;
    private final Material material;
    MobList(EntityType entityType, String friendlyName, Material material) {
    ...
    public static MobList getEggType(Entity entity) {
        for (MobList eggType : MobList.values()) {
